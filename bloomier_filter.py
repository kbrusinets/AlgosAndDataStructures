...
print(bloomier_filter.get_value(6))
print(bloomier_filter.get_value(68))
print(bloomier_filter.get_value(241))
print(bloomier_filter.get_value(532))
print(bloomier_filter.get_value(533))
print(bloomier_filter.get_value(534))